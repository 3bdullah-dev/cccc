      ...
      <div class="video-card real-card" data-aos="fade-up" data-card-id="${project.id}">
        <div class="video-container">
          <div class="video-placeholder"
            ...
            ${project.thumbnail
              ? `<img src="${project.thumbnail}" alt="${project.title}" class="video-thumb" loading="lazy" decoding="async" onerror="this.style.display='none'" />`
              : ``}
...
function restorePlaceholder(container) {
  ...
  placeholder.innerHTML = `
    ${project.thumbnail
      ? `<img src="${project.thumbnail}" alt="${project.title}" class="video-thumb" loading="lazy" decoding="async" />`
      : ""}
    <div class="play-btn" aria-hidden="true"><i class="fas fa-play"></i></div>
    <div class="video-overlay" aria-hidden="true"></div>
  `;
